...
def create_training_wrapper_from_config(model_config, model):
    ...
    if model_type == 'autoencoder':
        ...
        print(f"latent_mask_ration: {latent_mask_ratio}")
...
def create_demo_callback_from_config(model_config, **kwargs):
    ...
    if model_type == 'autoencoder':
        ...
        return AutoencoderDemoCallback(
            ...
            demo_dir=demo_config.get("demo_dir", "/home/node44_tmpdata3/netease/hkchen/stable-audio-tools-1/stable-audio-tools/outputs/demo"),
