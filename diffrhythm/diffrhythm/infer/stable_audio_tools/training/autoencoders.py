...
class AutoencoderDemoCallback(pl.Callback):
    def __init__(
        ...
        demo_dl, 
        demo_every=2000,
        demo_dir="/home/node44_tmpdata3/netease/hkchen/stable-audio-tools-1/stable-audio-tools/outputs/demo",
        sample_size=65536,
        sample_rate=48000
    ):
        super().__init__()
        ...
        print(f"demo saved at dir: {demo_dir}")
    ...
    def on_train_batch_end(self, trainer, module, outputs, batch, batch_idx): 
        ...
        try:
            demo_reals, aug_demo_reals, _ = next(self.demo_dl)

            # Remove extra dimension added by WebDataset
            if demo_reals.ndim == 4 and demo_reals.shape[0] == 1:
                demo_reals = demo_reals[0]

            encoder_input = aug_demo_reals
            ...
            # output_path = "/home/node44_tmpdata3/netease/hkchen/stable-audio-tools/outputs/demo/" + filename
