...
class AudioAutoencoder(nn.Module):
    ...
    def decode_audio(self, latents, chunked=False, overlap=32, chunk_size=128, **kwargs):
        ...
        if not chunked or total_size <= chunk_size:
            # if not chunked or latents are short, decode everything at once
            return self.decode(latents, **kwargs)
        ...
        # Handle the final chunk if total_size is not an exact multiple of chunk_size
        ...
        # Create an empty waveform, we will populate it with chunks as we decode them
        y_size = total_size * samples_per_latent
